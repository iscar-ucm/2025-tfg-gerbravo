...
# le pedimos al usuario que seleccione la carpeta donde guardar los resultados
CARPETA_RESULTADOS = filedialog.askdirectory(title="Selecciona la carpeta base donde guardar los fotogramas")
